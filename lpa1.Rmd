...
1. We will re-specify the LPA with CFA factor-scores / weighted sum scores as input (see [this article](https://scholarworks.umass.edu/cgi/viewcontent.cgi?article=1226&context=pare
)).
