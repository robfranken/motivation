...
Then, we use a three-step approach:


3. Estimate the movement between motivational profiles accros time points, keeping the latent profiles at each time point fixed and accounting for measurement error in profile assignment. 
